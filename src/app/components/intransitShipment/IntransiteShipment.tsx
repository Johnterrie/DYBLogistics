...
import IntransitShipmentFeed from '@/app/sections/intransitShipmentFeed/IntransitShipmentFeed';
...
const IntransiteShipment: React.FC<Props> = ({onAddShipment, onExport}) => {
  return (
...
export default IntransiteShipment