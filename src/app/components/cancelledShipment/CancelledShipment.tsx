"use client"
import CancelledShipmentFeed from '@/app/sections/cancelledShipmentFeed/CancelledShipmentFeed';
...
const CancelledShipment: React.FC<Props> = ({onAddShipment, onExport}) => {
  return (
