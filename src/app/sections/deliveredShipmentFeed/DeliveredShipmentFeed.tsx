    ...
    <div className='lg:px-50 sm:px-6 md:px-10 py-6'>
        <div className=' border rounded-lg border-[#E6E6E6] sm:px-4 py-2'>
            <div className='flex flex-wrap justify-between'>
                ...
                <Link href="/shipment/delivered" className='text-[#FD4A09] underline decoration-[#FD4A09]'>Delivered</Link>
...
export default DeliveredShipmentFeed