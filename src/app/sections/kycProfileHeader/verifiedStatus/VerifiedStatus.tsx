    ...
    <div>
      ...
      <div className="flex flex-col md:flex-row md:justify-between">
        ...
        <div className="flex gap-4 py-4">
          <h3 className="text-[#C5C5C5] text-lg">Profile</h3>
          <h3 className=" text-[#FD4A09] underline text-lg">Know Your Customer</h3>
        </div>
        ...
        <div className="flex gap-2 py-4 w-full md:w-auto md:mr-28">
          ...
          <div className="h-[39px] bg-[#28A745]">
            <h3 className="text-md text-white py-1 px-2">Approved</h3>
          </div>
        </div>
      </div>
    </div>
